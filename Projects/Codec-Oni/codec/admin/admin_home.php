...
<body>
		...
		<ul>
			...
			<li><a href="admin_home.php">Products</a>
				<ul>
					...
					<li><a href="admin_product.php "style="font-size:15px; margin-left:15px;">Photo</a></li>
					<li><a href="admin_music.php" style="font-size:15px; margin-left:15px;">Music</a></li>
					<li><a href="admin_ebook.php"style="font-size:15px; margin-left:15px;">E-Book</a></li>
				</ul>
			</li>
	...
	<h1>Wellcome To the Admin Dashboard of Codec Shop<h1>	<br>
<br>
<br>
<p>Developed By Tasnim Obaydi Oni<p>	
</div>
