...
<html>
	<head>
		<style>
			...
			.wrapper{width:50%;height:100%;margin:0 auto;background:#ededed;}
			form{margin-left:10%;padding: 3% 1%;}
			.field{margin: 3% 3%;width: 45%;padding: .7%}
			.label{text-align: justify;padding: 5% 1%;margin-left: 8%;color:#000}
	...
	<body>
		<div class="">
			<div class="wrapper">
				...
				<form name="myform" action="customer/customercheck.php" method="post" onsubmit="return formValidation()"> 
