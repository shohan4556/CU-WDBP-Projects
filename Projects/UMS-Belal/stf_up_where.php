...
<form id="signupform" name="signupform" method="post" action="create.php";>
  ...
  <p><form id="signupform" name="signupform" method="post" action="stf_update.php";>
...
$sql = "SELECT staff.id,staff.first_name,staff.mid_name,staff.last_name,staff.address,staff.email,staff.phone_num,staff.dept_name,staff.gender,staff.salary FROM staff WHERE   staff.id='$id'
 ";
...
<form id="signupform" name="signupform" method="post" action="stf_upinsert.php";>
