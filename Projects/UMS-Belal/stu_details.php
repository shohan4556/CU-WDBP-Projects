...
<form id="signupform" name="signupform" method="post" action="stu_search.php";>
 ...
 <p> <form id="signupform" name="signupform" method="post" action="create.php";>
...
result.subject,result.marks,result.gpa FROM stu_info,login,result WHERE stu_info.id=login.id AND stu_info.id=result.id ";
