...
<div id="cont">
<form id="signupform" name="signupform" method="post" action="stf_update.php";>
...
$sql = "UPDATE  staff  SET id = '$id' , first_name='$first_name' ,  mid_name='$mid_name', last_name='$last_name',
address='$address',
email='$email',
phone_num='$phone_num',
dept_name='$dept_name',
