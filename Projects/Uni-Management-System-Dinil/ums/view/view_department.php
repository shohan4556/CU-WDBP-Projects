            ...
            <div class="box-body">
                ...
                <div>
                    <ul class="nav nav-tabs">
                        ...
                        ?>
                        <li class="active" role="presentation"><a href="view_department.php">Active Departments</a></li>
                ...
                <div class="table-responsive col-md-12">
                    ...
                    <table id="table_info" class="table table-striped table-bordered">
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-default" onclick="return confirm('Are u sure to mve?')" href="?trashId=<?php echo $value["id"]; ?>">Move To
                                    Trash</a></td>
                        </tr>
                        <?php } ?>
                        </tbody>
